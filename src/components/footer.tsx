...
const socials = [
  ...
  { 
    name: "LinkedIn", 
    href: "https://www.linkedin.com/in/webdev-amjad/",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: "Twitter", 
    href: "https://twitter.com/aliamjad",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-6">
              {socials.map((social) => (
                <Link 
                  key={social.name} 
                  href={social.href} 
                  className="text-foreground/40 hover:text-accent transition-all hover:scale-110"
                  target="_blank"
